 ...
 * Vite configuration, and .env files before application startup.
 */
...
if (!fs.existsSync(path.join(projectRoot, 'src'))) {
  ...
  console.log(`${COLORS.yellow}Fix: Please navigate into the 'client' directory before running npm scripts.${COLORS.reset}`);
  process.exit(1);
} else {
...
console.log(`${COLORS.green}${COLORS.bold}✓ Frontend audit complete. All checks passed! Starting application...${COLORS.reset}\n`);
